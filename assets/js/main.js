...
function validateSubject(){
  ...
  var name =document.getElementById('contact-subject').value;
  if(name.lenght == 0){
      companyError.innerHTML = 'Subject is required';
      return false;
  }
  if(!name.match(/^[A-Za-z]+$/)){
      companyError.innerHTML = 'Enter Subject';
      return false;
  }
  console.log("Hello")
...
function validateForm(){
    ...
    if(!validateName()||!validateSubject()||!validateEmail() || !validatePhone() || !validateMessage()){
...
//submission
      ...
      $(document).ready(function(){
       $("#submit-form").submit((e) => {
        ...
        if (validateForm()){
        $.ajax({
          url: "https://formspree.io/f/xanyeewg",
